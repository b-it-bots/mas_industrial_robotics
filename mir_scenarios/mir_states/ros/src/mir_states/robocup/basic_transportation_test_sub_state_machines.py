    ...
    def __init__(self, use_mockup=None):
        ...
        with self:
            ...
            smach.StateMachine.add(
                ...
                transitions={
                    "obj_selected": "COMPUTE_ARM_BASE_SHIFT_TO_OBJECT",
            ...
            smach.StateMachine.add(
                ...
                transitions={
                    "success": "STOP_COMPUTE_ARM_BASE_SHIFT_TO_OBJECT",
            ...
            smach.StateMachine.add(
                ...
                transitions={"loop": "START_VISUAL_SERVOING", "continue": "GRASP_OBJ",},
            )

            smach.StateMachine.add(
                "START_VISUAL_SERVOING",
                gbs.send_event(
                    [("/mir_controllers/visual_servoing/event_in", "e_start")]
                ),
            ...
            smach.StateMachine.add(
                ...
                gbs.send_event(
                    [("/mir_controllers/visual_servoing/event_in", "e_stop")]
                ),
            ...
            smach.StateMachine.add(
                "APPROACH_OBJECT",
                gbs.send_event(
                    [("/guarded_approach_pose/coordinator/event_in", "e_start",)]
                ),
            ...
            smach.StateMachine.add(
                ...
                gbs.send_event(
                    [("/guarded_approach_pose/coordinator/event_in", "e_stop")]
                ),
            ...
            smach.StateMachine.add(
                ...
                transitions={
                    "pose_skipped": "SELECT_SOURCE_SUBTASK",
    ...
    def __init__(self):
        ...
        with self:
            ...
            smach.StateMachine.add(
                ...
                transitions={"succeeded": "overall_done", "failed": "MOVE_TO_EXIT",},
            )
    ...
    def __init__(self):
        ...
        with self:
            ...
            smach.StateMachine.add(
                ...
                transitions={
                    "object_grasped": "PLACE_OBJ_IN_CONFIGURATION",
