        ...
        with self:
            ...
            smach.StateMachine.add(
                ...
                gbs.send_and_wait_events_combined(
                    ...
                    event_out_list=[
                        ("/plate_pose_shifter/event_out", "e_success", True)
                    ],
                    timeout_duration=5,
                ),
                transitions={
            ...
            smach.StateMachine.add(
                ...
                gbs.send_and_wait_events_combined(
                    ...
                    event_out_list=[
                        ("/pregrasp_planner_pipeline/event_out", "e_success", True)
                    ],
                ),
                transitions={
            ...
            smach.StateMachine.add(
                ...
                gbs.send_event([("/pregrasp_planner_pipeline/event_in", "e_stop")]),
            ...
            smach.StateMachine.add(
                ...
                gbs.send_and_wait_events_combined(
                    ...
                    event_out_list=[
                        ("/poses_to_move_wrtgripper/event_out", "e_success", True)
                    ],
                    timeout_duration=10,
                ),
                transitions={
            ...
            smach.StateMachine.add(
                ...
                gbs.send_and_wait_events_combined(
                    ...
                    event_out_list=[
                        ("/cartesian_controller_demo/event_out", "e_success", True)
                    ],
                    timeout_duration=10,
                ),
                transitions={
            ...
            smach.StateMachine.add(
                ...
                gbs.send_and_wait_events_combined(
                    ...
                    event_out_list=[
                        ("/gripper_state_monitor/event_out", "e_gripper_closed", True)
                    ],
                    timeout_duration=5,
                ),
                transitions={
