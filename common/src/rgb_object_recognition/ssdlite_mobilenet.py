...
class SSDLiteMobilenet():
  def __init__(self, checkpoint_dir): 
    ...
    PATH_TO_LABELS = os.path.join(checkpoint_dir, 'atwork_label_map.pbtxt')
    ...
    with detection_graph.as_default():
      ...
      with tf.Session() as self.sess:
        ...
        ip_shape = tf.shape(self.image_tensor)
        self.image_width = ip_shape[1]
        self.image_height = ip_shape[2]
