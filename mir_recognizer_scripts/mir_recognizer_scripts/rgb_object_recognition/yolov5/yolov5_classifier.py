...
def main():
    ...
    model_file = os.path.join(get_package_share_directory("mir_rgb_object_recognition_models"),
                              'common', 'models', 'yolov5', 'atwork_realdata_combined', "best.pt")

    inference_image_file = os.path.join(get_package_share_directory("mir_recognizer_scripts"),
                                        'mir_recognizer_scripts','rgb_object_recognition', 'yolov5', 'data',
                                        'images', 'zidane.jpg')

    data_yaml = os.path.join(get_package_share_directory("mir_recognizer_scripts"),
