...
class GripperServiceServer:
	def __init__(self):
		...
		# service server
		self.srv_gripper_closed = rospy.Service('is_gripper_closed',  mir_manipulation_msgs.srv.IsGripperClosed , self.is_gripper_closed)
...
if __name__ == "__main__":
	...
	gripper_srv = GripperServiceServer()		
	rospy.loginfo("gripper service server started")
	rospy.spin()
