#! /usr/bin/env python
"""
This module call different planners depending on the request with the provided
...
class PlannerWrapper(object):
    ...
    :planner_commands: dict
    :keyword arguments: (optional)
        :plan_dir: string
        :plan_backup_dir: string
    ...
    def plan(self, planner, domain_file, problem_file, fast_mode=False):
        ...
        :planner: string
        :domain_file: string (path to domain pddl file)
        :problem_file: string (path to problem pddl file)
        :fast_mode: bool
