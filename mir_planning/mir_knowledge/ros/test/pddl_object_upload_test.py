    ...
    def test_parse_objects(self):
        ...
        grippers_knowledge = [
            utils.create_knowledge_unit_dict(
                0,
                utils.create_knowledge_dict(
                    instance_type="gripper", instance_name=gripper
                ),
            )
        ...
        locations_knowledge = [
            utils.create_knowledge_unit_dict(
                0,
                utils.create_knowledge_dict(
                    instance_type="location", instance_name=location
                ),
            )
        ...
        objects_knowledge = [
            utils.create_knowledge_unit_dict(
                0,
                utils.create_knowledge_dict(instance_type="object", instance_name=obj),
            )
            for obj in objects
        ]
        ...
        robots_knowledge = [
            utils.create_knowledge_unit_dict(
                0,
                utils.create_knowledge_dict(instance_type="robot", instance_name=robot),
            )
            for robot in robots
        ]
        ...
        robot_platforms_knowledge = [
            utils.create_knowledge_unit_dict(
                0,
                utils.create_knowledge_dict(
                    instance_type="robot_platform", instance_name=robot_platform
                ),
            )
