...
PickAction::PickAction() : ExecutorAction("/wbc_pick_object_server") {
    //move_base_client_.waitForServer();
}

void PickAction::update_knowledge_base(bool success, std::vector<diagnostic_msgs::KeyValue>& params)
{
...
void PickAction::updateParamsBasedOnContext(std::vector<diagnostic_msgs::KeyValue>& params)
{
