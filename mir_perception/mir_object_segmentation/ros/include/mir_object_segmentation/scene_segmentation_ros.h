...
class SceneSegmentationROS
{
    ...
    public:
         ...
         * \param[in] Radius of the sphere that will determine which points are neighbors.
         * \param[in] The number of neighbors that need to be present in order to be classified as an inlier.
         * */
         ...
         * \param[in] The minimum number of points that a cluster must contain in order to be accepted
         * \param[in] The maximum number of points that a cluster must contain in order to be accepted
