...
LabelVisualizer::LabelVisualizer(const ros::NodeHandle &nh, const std::string& topic_name, Color color, bool check_subscribers)
    : color_(color)
...
void LabelVisualizer::publish(const std::vector<std::string> &labels, const geometry_msgs::PoseArray &poses)
{
