 ...
 *
 */
#ifndef MIR_PERCEPTION_UTILS_OCTREE_POINTCLOUD_OCCUPANCY_COLORED_H
#define MIR_PERCEPTION_UTILS_OCTREE_POINTCLOUD_OCCUPANCY_COLORED_H
...
class OctreePointCloudOccupancyColored
 ...
 public:
  ...
  void setOccupiedVoxelsAtPointsFromCloud(
  ...
  void getOccupiedVoxelCentersWithColor(
...
#endif  // MIR_PERCEPTION_UTILS_OCTREE_POINTCLOUD_OCCUPANCY_COLORED_H
